<template>
    <div class="account">
        ...
        <p class="st-text st-text--section">Change your Alias and Keycode</p>
        ...
        <p class="st-text st-text--section">Setup your Keycode</p>
        <p class="st-text">Important! One need to setup a "keycode" for the timetable app to work.</p>
        <p class="st-text">To use, enter your information below and press 'setup' - feel free to leave fields empty.</p>
        <form class="st-form" style="margin-top: 0.5rem" @submit.prevent="submitSetup">
            <div class="st-form__control st-form__control--small">
                <label class="st-form__label st-form__label--multi" style="width: 50%;">
        ...
        <p class="st-text st-text--section">Manual Keycode Setup</p>
        <p class="st-text">
        ...
        <Dialog :is-open="showInstructions" :on-close="() => setInstructions(false)"
            ...
            <p class="st-text st-text--section">Step 1: Log into PCSchool Spider</p>
            <p class="st-text">
                Visit the link
                <a class="st-text st-text--link" target="_blank" href="https://spider.scotscollege.school.nz/Spider2011/Pages/Login.aspx?ReturnUrl=/Spider2011/Pages/Home.aspx">https://spider.scotscollege.school.nz/Spider2011/Pages/Login.aspx?ReturnUrl=/Spider2011/Pages/Home.aspx</a>,
                <br/>
                then sign in with your credentials.
            </p>

            <p class="st-text st-text--section">Step 2: Open the Developer Tools</p>
            <p class="st-text">
            ...
            <p class="st-text st-text--section">Step 3: Navigate to the Student Information</p>
            <p>
                On the website (not the DevTools), click on the link labeled 'Student Information'. This should bring you to your information page.
            </p>

            <p class="st-text st-text--section">Step 4: Get your keycode from a Request</p>
            <p>
            ...
            <p class="st-text st-text--section">Step 5: Enter your keycode</p>
            <p class="st-text">Close this dialog, and in the section "Change your Alias and Keycode" under Account, enter your new keycode at the input labeled "Network Keycode", and press "Change". Head back to TIMETABLE to see your timetable!</p>
        </Dialog>
    </div>
</template>
